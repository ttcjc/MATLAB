...
% v1.2 - Added Support for Full-Scale Windsor Model Simulations
...
switch format
    ...
    case 'A'
        ...
        xLims = round(xDims(2), spacePrecision);
        ...
        precision = num2str(spacePrecision);
    ...
    case 'B'
        ...
        elseif contains(caseType, 'Windsor') && contains(caseType, 'fullScale')
            xLims = [1.275; 18.637]; % 4L
            yLims = [-2.9232; 2.9232];
            zLims = [cellSize; 3.3408];
        end
    ...
    case 'C'
        ...
        if contains(caseType, 'Run_Test') || (contains(caseType, 'Windsor') && contains(caseType, 'Upstream'))
            ...
            meshPoints = meshPoints((meshPoints(:,1) > -1.75),:);
        elseif contains(caseType, 'Windsor') && contains(caseType, 'fullScale')
            meshPoints(:,1) = meshPoints(:,1) - (max(meshPoints(:,1)) - min(meshPoints(:,1)));
            ...
            meshPoints = meshPoints((meshPoints(:,1) > -1.7),:);
        end
