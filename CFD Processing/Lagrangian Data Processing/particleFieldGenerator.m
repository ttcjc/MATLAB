%% Particle Volume Field Generator v1.2
...
disp ('====================================');
disp ('Particle Volume Field Generator v1.2');
disp ('====================================');
disp (' ');
...
disp('    A: Downstream (Self-Contamination Case)');
disp('    B: Upstream (Third-Party Contamination Case)');
disp(' ');
...
%     fieldData.dMean{i,1} = ((6 / pi) * (fieldData.volumeFraction{i,1} ./ max(fieldData.nParticles{i,1},1))).^(1 / 3);
    ...
    clf(fig);
    set(figure(fig), 'name', ['Lagrangian Volume Field (', num2str(particleData.time{times(i),1}), 's)']);
    ...
    savefig(fig, ['~/MATLAB/Output/Figures/', caseFolder(namePos(end):end), '_Particle_Field_D', num2str(minD), '_D', num2str(maxD), '_', timeInst, 's']);
    print(fig, ['~/MATLAB/Output/Figures/', caseFolder(namePos(end):end), '_Particle_Field_D', num2str(minD), '_D', num2str(maxD), '_', timeInst, 's'], '-dpng', '-r300');
