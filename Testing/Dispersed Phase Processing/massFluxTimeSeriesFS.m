...
% plot(uncoupled.(planes{plotPlane}).time, (uncoupled.(planes{plotPlane}).massFlow / dT), ...
%      'color', graphColours(4), 'lineWidth', 2);
% plot(coupled.(planes{plotPlane}).time, (coupled.(planes{plotPlane}).massFlow / dT), ...
...
% %      'color', graphColours(7), 'lineWidth', 2);Deg.(planes{plotPlane}).massFlow, 1048), ...
