...
function [fig, planeNo] = plotPlanarVectorField_legacy(orientation, xLimsData, yLimsData, zLimsData, positionData, ...
                                                       vectorData, nComponents, component, mapPerim, ...
                                                       nPlanes, planeNo, fig, figName, cMap, geometry, ...
                                                       streamlines, xDims, yDims, zDims, figTitle, figSubtitle, ...
                                                       cLims, xLimsPlot, yLimsPlot, zLimsPlot, normalise, figSave)
    ...
    switch orientation
        ...
        case 'YZ'
            uInterp = scatteredInterpolant(positionData(:,2), positionData(:,3), vectorData(:,1), ...
                                           'linear', 'none');
            vInterp = scatteredInterpolant(positionData(:,2), positionData(:,3), vectorData(:,2), ...
                                           'linear', 'none');
            wInterp = scatteredInterpolant(positionData(:,2), positionData(:,3), vectorData(:,3), ...
                                           'linear', 'none');
        ...
        case 'XZ'
            uInterp = scatteredInterpolant(positionData(:,1), positionData(:,3), vectorData(:,1), ...
                                           'linear', 'none');
            vInterp = scatteredInterpolant(positionData(:,1), positionData(:,3), vectorData(:,2), ...
                                           'linear', 'none');
            wInterp = scatteredInterpolant(positionData(:,1), positionData(:,3), vectorData(:,3), ...
                                           'linear', 'none');
        ...
        case 'XY'
            uInterp = scatteredInterpolant(positionData(:,1), positionData(:,2), vectorData(:,1), ...
                                           'linear', 'none');
            vInterp = scatteredInterpolant(positionData(:,1), positionData(:,2), vectorData(:,2), ...
                                           'linear', 'none');
            wInterp = scatteredInterpolant(positionData(:,1), positionData(:,2), vectorData(:,3), ...
                                           'linear', 'none');
...
%             end
            ...
            if streamlines
                ...
                streams = streamslice(x, y, z, zeros(size(x)), v, w, xLimsData, [], [], ...
                                      2, 'arrows', 'linear');
                set(streams, 'color', 'k', 'lineStyle', '-', 'lineWidth', 1.5);
            end
