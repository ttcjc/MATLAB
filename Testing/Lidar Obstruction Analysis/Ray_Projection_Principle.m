...
peakA = (18.637 / normLength) - 1.8671; peakA = [peakA, 0, 0.182];
peakB = (18.637 / normLength) - 2.1521; peakB = [peakB, 0, 0.182];
peakC = (18.637 / normLength) - 2.8132; peakC = [peakC, 0, 0.182];
peakD = (18.637 / normLength) - 3.1339; peakD = [peakD, 0, 0.182];
...
%             end
            ...
            fieldData = reshape(full(volumeData.nParticles.inst{j}), gridShape);
            ...
            plot3(peakA(:,1), peakA(:,2), peakA(:,3), 'lineStyle', 'none', ...
                                                      'marker', 'o', ...
                                                      'markerSize', 10, ...
                                                      'markerFaceColor', graphColours(2), ...
                                                      'markerEdgeColor', graphColours(2));
                                                  
            plot3(peakB(:,1), peakB(:,2), peakB(:,3), 'lineStyle', 'none', ...
                                                      'marker', 'o', ...
                                                      'markerSize', 10, ...
                                                      'markerFaceColor', graphColours(2), ...
                                                      'markerEdgeColor', graphColours(2));
                                                  
            plot3(peakC(:,1), peakC(:,2), peakC(:,3), 'lineStyle', 'none', ...
                                                      'marker', 'o', ...
                                                      'markerSize', 10, ...
                                                      'markerFaceColor', graphColours(2), ...
                                                      'markerEdgeColor', graphColours(2));
                                                  
            plot3(peakD(:,1), peakD(:,2), peakD(:,3), 'lineStyle', 'none', ...
                                                      'marker', 'o', ...
                                                      'markerSize', 10, ...
                                                      'markerFaceColor', graphColours(2), ...
                                                      'markerEdgeColor', graphColours(2));
